    ...
    <section class="content">
        <div class="row">
            ...
            <div class="container-fluid" style="margin:0 0 10px 0;">
                            <div class="row">
                                <div class="col-10 col-sm-8 col-md-6 col-offset-1 col-sm-offset-2 col-md-offset-3">
                                    <form action="<?php echo e(route('orderDeliverSearch.admin')); ?>" method="GET" class="w-100">
            ...
            <div class="col-xs-12">
                ...
                <div class="box">
                    <div class="main-flex">
                        <h3 class="box-title">All Deliver Orders</h3>
                    </div><!-- /.box-header -->
                    <div class="box-body">
...
<?php echo $__env->make('layouts.admin.admin-layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\sajjel\laragon\www\carpartslb.com\resources\views/admin/order/deliver.blade.php ENDPATH**/ ?>