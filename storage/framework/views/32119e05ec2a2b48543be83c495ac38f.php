        ...
        <div class="row">
            ...
            <div class="col-xs-12">
                ...
                <?php $__currentLoopData = $types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="modal fade" id="deleteModal<?php echo e($type->id); ?>" tabindex="-1" role="dialog"
                        aria-hidden="true">
                                                    ...
                                                    <div class="action-container">
                                                        ...
                                                        <a href="javascript:void(0)" class="">
                                                            <span class="delete-icon fa fa-trash-o" data-toggle="modal"
                                                                data-target="#deleteModal<?php echo e($type->id); ?>"
                                                                data-id="<?php echo e($type->id); ?>"><i></i></span>
                                                        </a>
...
<?php echo $__env->make('layouts.admin.admin-layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\sajjel\laragon\www\carpartslb.com\resources\views/admin/type/index.blade.php ENDPATH**/ ?>