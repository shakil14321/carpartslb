                    ...
                    <div class="col">
                        <div class="account__login">
                            ...
                            <p class="account__login--signup__text">Didn’t receive the verification code? <a
                                    href="<?php echo e(route('verify.resend')); ?>">Resend Code</a></p>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.front.front-layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\sajjel\laragon\www\carpartslb.com\resources\views/front/pages/verify-email.blade.php ENDPATH**/ ?>