            ...
            <div class="col">
                <div class="breadcrumb__content text-center">
                    ...
                    <ul class="breadcrumb__content--menu d-flex justify-content-center">
                        ...
                        <li class="breadcrumb__content--menu__items"><span>By Brand</span></li>
                    </ul>
                </div>
            </div>
        </div>
                            ...
                            <div class="small__product--card d-flex">
                                <div class="small__product--thumbnail">
                                    ...
                                    <img class="product__card--thumbnail__img product__primary--img"
                                        src="<?php echo e(asset('images/parts/feature/' . $carPartFav->feature_image)); ?>"
                                        alt="feature_img">
                                    <?php else: ?>
                                    <img class="product__card--thumbnail__img product__primary--img"
                                        src="<?php echo e(asset('images/brands/demo.png')); ?>" alt="no-image">
                                    <?php endif; ?>
...
<?php echo $__env->make('layouts.front.front-layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u770170027/domains/carpartslb.com/public_html/resources/views/front/pages/brand.blade.php ENDPATH**/ ?>