...
<meta property="og:image" content="<?php echo e($carPart->feature_image ? asset('public/images/parts/feature/' . $carPart->feature_image) : ''); ?>">
...
<meta name="twitter:image" content="<?php echo e($carPart->feature_image ? asset('public/images/parts/feature/' . $carPart->feature_image) : ''); ?>">
                                ...
                                <div class="product__media--preview__items">
                                    <a class="product__media--preview__items--link glightbox"
                                        ...
                                        <img class="product__media--preview__items--img"
                                            src="<?php echo e(asset('public/images/parts/gallery/' . $img)); ?>" alt="product-gallery-img">
                                    </a>
                                    <div class="product__media--view__icon">
                                        <a class="product__media--view__icon--link glightbox"
                                            href="<?php echo e(asset('public/images/parts/gallery/' . $img)); ?>"
                    ...
                    <div class="single__product--nav swiper">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div class="product__media--nav__items">
                                    <img class="product__media--nav__items--img"
                                        src="<?php echo e(asset('public/images/parts/gallery/' . $img)); ?>" alt="product-nav-img">
                                </div>
                            </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                ...
                <div class="product__details--info">
                    <form action="#">
                        ...
                        <div class="product__details--info__price mb-12">
                            <span class="current__price"><?php echo e($carPart->sale_price ? '$'.$carPart->sale_price : ''); ?></span>
                            <span class="old__price"><?php echo e($carPart->original_price ? '$'.$carPart->original_price : ''); ?></span>
                        </div>
                        <ul class="rating product__card--rating mb-15 d-flex">
                            ...
                            <li> <?php if($productReviews->count() > 0): ?>
                                    <span class="rating__review--text"><?php echo e($productReviews->count() . ' Reviews'); ?></span>
                                <?php else: ?>
                        ...
                        <div class="product__variant">
                            <div class="product__variant--list quantity d-flex align-items-center mb-20">
                                ...
                                <button class="product__card--btn primary__btn add-to-cart-btn"  
                                    data-id="<?php echo e($carPart->id); ?>"
                                    data-name="<?php echo e($carPart->title); ?>"
                                    ...
                                    data-image="<?php echo e($carPart->feature_image ?? 'demo.png'); ?>"
                                    type="button">
                            ...
                            <div class="product__variant--list mb-15">
                                <div class="product__details--info__meta">
                                    ...
                                    <p class="product__details--info__meta--list"><strong>Category:</strong> <span><?php echo e($carPart->carPartType->title ?? 'None'); ?></span> </p>
                                            
                                    <p class="product__details--info__meta--list"><strong>Part#:</strong> <span><?php echo e(ucwords($carPart->part_number ?? '')); ?></span> </p>        
                                            
                                    
                                    <div class="part_brnad_image_sec">
                                        <img 
                                          src="<?php echo e(asset('public/images/brands/' . ($carPart->carPartBrand->brand_image ?? 'demo.png'))); ?>" 
                                          alt="<?php echo e($carPart->carPartBrand->title ?? 'Brand Image'); ?>" style="width:120px; height:60px; border-radius:10px;" 
                                        />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="product__reviews">
                                <div class="product__reviews--header">
                                    ...
                                    <div class="reviews__ratting d-flex align-items-center">
                                        ...
                                        <span class="reviews__summary--caption">Based on <?php echo e($productReviews->count() ?? ''); ?> reviews</span>
                                    </div>
                                        ...
                                        <div class="reviews__comment--content">
                                            <div class="reviews__comment--top d-flex justify-content-between">
                                                <div class="reviews__comment--top__left">
                                                    <h3 class="reviews__comment--content__title h4"><?php echo e(ucwords($productReview->username ?? '')); ?></h3>
                                                    <ul class="rating d-flex">
                                                        <?php for($i=1; $i <= 5; $i++): ?>
                                                            <li class="rating__list">
                                                                <span class="rating__icon">
                                                ...
                                                <span class="reviews__comment--content__date"><?php echo e($productReview->updated_at->format('M d, Y') ?? ''); ?></span>
                                            </div>
                                            <p class="reviews__comment--content__desc"><?php echo e($productReview->review ?? ''); ?></p>
                                        </div>
                                    </div>
                                    <?php if($productReview->reply): ?>
                                        <div class="reviews__comment--list margin__left d-flex">
                                            ...
                                            <div class="reviews__comment--content">
                                                <div class="reviews__comment--top d-flex justify-content-between">
                                                    <div class="reviews__comment--top__left">
                                                        <h3 class="reviews__comment--content__title h4"><?php echo e($productReview->reply_admin_name ?? ''); ?></h3>
                                                    </div>
                                                </div>
                                                <p class="reviews__comment--content__desc"><?php echo e($productReview->reply ?? ''); ?></p>
                                            </div>
                                        </div>
                                    <?php endif; ?>
                                </div>
                                ...
                                <div id="writereview" class="reviews__comment--reply__area">
                                    <form action="<?php echo e(route('review.store')); ?>" method="POST">
                                        ...
                                        <div class="row">
                                            <input type="hidden" name="product_id" value="<?php echo e($carPart->id ?? ''); ?>">
                                            <input type="hidden" name="product_title" value="<?php echo e($carPart->title ?? ''); ?>">
                                            <input type="hidden" name="product_url" value="<?php echo e(url()->current()); ?>">
                                            <input type="hidden" name="user_image" value="<?php echo e(Auth::user()->user_image); ?>">
                                            <input type="hidden" name="rating" id="rating" value="0">
                                            
                                            <div class="col-12 mb-10">
                                                <textarea class="reviews__comment--reply__textarea"
                                                    placeholder="Your Comments...." name="review"><?php echo e(old('review')); ?></textarea>
                                            </div>
                                            <div class="col-lg-6 col-md-6 mb-15">
                                                <label>
                                                    <input class="reviews__comment--reply__input"
                                                        placeholder="Your Name...." type="text" value="<?php echo e(Auth::user()->name ?? ''); ?>" readonly>
                                                </label>
                                            </div>
                                            <div class="col-lg-6 col-md-6 mb-15">
                                                <label>
                                                    <input class="reviews__comment--reply__input"
                                                        placeholder="Your Email...." type="email" value="<?php echo e(Auth::user()->email ?? ''); ?>" readonly>
                                                </label>
                                            </div>
                                        </div>
                                ...
                                <?php else: ?>
                                <h3 class="text-danger fw-bold">To share your valuable review, please log in <a href="<?php echo e(route('login.form')); ?>" class="text-decoration-underline">log in</a> first.</h3>
                                <?php endif; ?>
                            </div>
                            <script>
                ...
                <div class="swiper-slide">
                    <article class="product__card">
                        <div class="product__card--thumbnail">
                            <a class="product__card--thumbnail__link display-block" href="<?php echo e(route('product.view', $related->slug)); ?>">
                        ...
                        <div class="product__card--content">
                            <h3 class="product__card--title"><a href="<?php echo e(route('product.view', $related->slug)); ?>"><?php echo e($related->title ?? ''); ?></a>
                            </h3>
                            
                            <div class="d-flex justify-content-between">
                                <div>
                                    <p class="oth_brand_title"><span class="oth_p">Brand:</span> <span class="rating__review--text"><?php echo e(ucwords($carPart->carBrand->title ?? '')); ?></span></p>
                                            
                                    
                                            
                                    <p class="oth_p_part"><span class="oth_p">Part#:</span> <span class="rating__review--text"><?php echo e(ucwords($carPart->part_number ?? '')); ?></span></p>
                                </div>
                                <div class="part_brnad_image_sec">
                                    <img 
                                        src="<?php echo e(asset('public/images/brands/' . ($carPart->carPartBrand->brand_image ?? 'demo.png'))); ?>" 
                                            alt="<?php echo e($carPart->carPartBrand->title ?? 'Brand Image'); ?>" style="width:120px; height:60px; border:1px solid #a7a8a3; border-radius:10px;" 
                                    />
                                </div>
                            </div>
                                    
                            <div class="product__card--price">
                                <span class="current__price"><?php echo e($related->sale_price ? '$'.$related->sale_price :
                                    ''); ?></span>
                                <span class="old__price"> <?php echo e($related->original_price ? '$'.$related->original_price :
                                    ''); ?></span>
                            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.front.front-layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u770170027/domains/carpartslb.com/public_html/resources/views/front/pages/product.blade.php ENDPATH**/ ?>