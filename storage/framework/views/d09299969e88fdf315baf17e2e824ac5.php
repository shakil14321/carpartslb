                                            ...
                                            <a href="<?php echo e(route('type.view', $carPartType->slug)); ?>">
                                                <label class="widget__categories--menu__label d-flex align-items-center">
                                                    <img class="widget__categories--menu__img"
                                                        src="<?php echo e($carPartType->part_type_image
                                                            ? asset('public/images/types/' . $carPartType->part_type_image)
                                                            : asset('public/images/types/demo.png')); ?>"
                                                        alt="categories-img">

                                                    <span
                                                        class="widget__categories--menu__text lh-base"><?php echo e($carPartType->title); ?></span>
                                                </label>
                                            </a>
                                        </li>
                                        ...
                                        <div class="small__product--card">
                                            <div class="small__product--thumbnail">
                                                <a class="display-block"
                                                    href="<?php echo e(route('product.view', $carPartFav->slug)); ?>"
                                                    ...
                                                    <?php else: ?>
                                                        <img class="product__card--thumbnail__img product__primary--img"
                                                            src="<?php echo e(asset('public/images/brands/demo.png')); ?>"
                                                            alt="no-image"
                                                            style="width:100%; height:100%; object-fit:cover;">
                                                    <?php endif; ?>
                                                </a>
                                ...
                                <div id="product_grid" class="tab_pane active show">
                                    <div class="product__section--inner">
                                        <div class="row mb--n30" id="car-parts-container">
                                            <?php echo $__env->make('front.partials.car_parts_list', [
                                                'carParts' => $carParts,
...
<?php echo $__env->make('layouts.front.front-layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\sajjel\laragon\www\carpartslb.com\resources\views/front/pages/shop.blade.php ENDPATH**/ ?>