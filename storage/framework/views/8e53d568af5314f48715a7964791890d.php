                    ...
                    <div class="footer__widget">
                        ...
                        <div class="footer__widget--inner">
                            ...
                            <p class="footer__widget--desc">
                                <?php echo e($setting && $setting->footer_about_text
                ...
                <ul class="social__share footer__social d-flex">
                    <li class="social__share--list">
                        <a class="social__share--icon__style2" target="_blank"
                            href="<?php echo e($setting && $setting->footer_facebook_link ? $setting->footer_facebook_link : 'javascript:void(0)'); ?>">
                    ...
                    <li class="social__share--list">
                        <a class="social__share--icon__style2" target="_blank"
                            href="<?php echo e($setting && $setting->footer_instagram_link ? $setting->footer_instagram_link : 'javascript:void(0)'); ?>">
