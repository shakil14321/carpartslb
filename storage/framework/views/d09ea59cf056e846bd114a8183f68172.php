        ...
        <div class="main__header--inner position__relative d-flex justify-content-between align-items-center px-2">
            ...
            <div class="main__logo">
                    <h1 class="main__logo--title"><a class="main__logo--link" href="<?php echo e(route('home')); ?>"><img
                            class="main__logo--img" src="<?php echo e(asset($setting && $setting->site_logo ? 'public/images/logos/' . $setting->site_logo : 'public/images/logos/demo.png')); ?>"
                            ...
                            <?php $__currentLoopData = $setting->menu_items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="header__menu--items">
                                    <?php
                                        $routeName = $menu['name'];
                                    ?>
                                    <a href="<?php echo e($menu['link']); ?>" class="header__menu--link <?php echo e(request()->routeIs(strtolower($routeName)) ? 'active' : ''); ?>"><?php echo e($menu['name']); ?></a>
                                </li>
...
<?php /**PATH /home/u770170027/domains/carpartslb.com/public_html/resources/views/components/Front/sticky_header_menu.blade.php ENDPATH**/ ?>