    ...
    <div class="container">
        <div class="main__header--inner position__relative d-flex justify-content-between align-items-center px-2">
            ...
            <div class="main__logo">
                <h1 class="main__logo--title"><a class="main__logo--link" href="<?php echo e(route('home')); ?>"><img
                            class="main__logo--img"
                            src="<?php echo e(asset($setting && $setting->site_logo ? 'public/images/logos/' . $setting->site_logo : 'public/images/logos/demo.png')); ?>"
                            alt="logo-img" width="175px"></a></h1>
            </div>
            
            <div class="header__search--widget d-none d-lg-block header__sticky--none">
                <form class="d-flex header__search--form border-radius-5" action="<?php echo e(route('search.page')); ?>"
                    method="GET">
                            ...
                            <?php $__currentLoopData = $setting->menu_items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="header__menu--items">
                                    ...
                                    <a href="<?php echo e($menu['link']); ?>"
                                        class="header__menu--link <?php echo e(request()->routeIs(strtolower($routeName)) ? 'active' : ''); ?>"><?php echo e($menu['name']); ?></a>
                                </li>
                ...
                <ul class="header__account--wrapper d-flex align-items-center">
                    ...
                    <li class="header__account--items header__minicart--items">
                        <a class="header__account--btn minicart__open--btn" href="javascript:void(0)" data-offcanvas>
                            ...
                            <span class="items__count"><?php echo e(count(session('cart', []))); ?></span>
...
<div class="seach_form_container">
    <form class="d-flex header__search--form border-radius-5" action="<?php echo e(route('search.page')); ?>" method="GET">
        <div class="header__search--box">
            <label for="search_field">
                <input id="globalSearch" name="query" class="header__search--input"
                    placeholder="Search For Products..." type="text" autocomplete="off"
...
<<<<<<<< HEAD:storage/framework/views/58daf9e9704f3c3b944d1d7f4fe3eb86.php
<?php /**PATH F:\laragon\www\carpartslb.com\resources\views/components/Front/sticky_header_menu.blade.php ENDPATH**/ ?>
========
<?php /**PATH E:\sajjel\laragon\www\carpartslb.com\resources\views/components/Front/sticky_header_menu.blade.php ENDPATH**/ ?>
>>>>>>>> 111d9aad5c681fcad64fc7e1745777f4ca95bd73:storage/framework/views/2ac52554c95d118ee11a46910798fd36.php
