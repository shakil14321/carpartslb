...
<section class="content">
    <div class="row">
        ...
        <div class="modal fade" id="deleteModal<?php echo e($user->id); ?>" tabindex="-1" role="dialog" aria-hidden="true">
                ...
                <div class="box-body">
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                 <td>
                                    <input type="checkbox" name="ids[]" value="<?php echo e($user->id); ?>" class="checkbox">
                                </td>
                                ...
                                <td><p class="verificaton_btn <?php echo e(!is_null($user->email_verified_at) ? 'text-success' : 'text-danger'); ?>"><?php echo e(!is_null($user->email_verified_at) ? "Done" : "None"); ?></p></td>
                                <td>
                                    <div class="action-container">
                                        <a href="<?php echo e(route('user.edit', $user->id)); ?>" class="edit-icon"><i
                                                class="fa fa-edit"></i></a>
                                        <span class="delete-icon fa fa-trash-o" data-toggle="modal" data-target="#deleteModal<?php echo e($user->id); ?>" data-id="<?php echo e($user->id); ?>"><i></i></span>
...
<?php echo $__env->make('layouts.admin.admin-layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u770170027/domains/carpartslb.com/public_html/resources/views/admin/user/author.blade.php ENDPATH**/ ?>