                    ...
                    <div class="footer__widget">
                        ...
                        <ul class="footer__widget--menu footer__widget--inner d-flex justify-content-between align-items-center">
                            ...
                            <li class="footer__widget--menu__list"><a class="footer__widget--menu__text"
                                    href="<?php echo e(auth()->check() ? route('customerDashboard') : route('login.form')); ?>"><?php echo e(auth()->check() ? 'My Account' : 'My Account'); ?></a></li>
                            <li class="footer__widget--menu__list"><a class="footer__widget--menu__text"
...
<!-- End footer section -->
<?php /**PATH /home/u770170027/domains/carpartslb.com/public_html/resources/views/components/Front/footer.blade.php ENDPATH**/ ?>