                    ...
                    <div class="col">
                        <div class="account__login">
                            <div class="account__login--header mb-25">
                                <h2 class="account__login--header__title mb-10">Request Password Reset</h2>
                                    <?php if($errors->any()): ?>
                            ...
                            <div class="account__login--inner">
                                ...
                                <button class="account__login--btn primary__btn" type="submit">Send Reset Code</button>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.front.front-layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u770170027/domains/carpartslb.com/public_html/resources/views/front/pages/password-reset.blade.php ENDPATH**/ ?>