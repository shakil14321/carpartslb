        ...
        <div class="header__topbar--inner custom-gap-mobile">
            <ul class="header__topbar--info">
                <li class="header__info--list notic_content">
                    ...
                    <p><?php echo e($setting && $setting->shipping_text ? $setting->shipping_text : 'Shipping 6 Days/Week'); ?></span>
                    </p>
            ...
            <div class="header__top--right d-flex align-items-center">
                <ul class="header__topbar--info">
                    <li class="header__info--list notic_content">
                        ...
                        <p><?php echo e($setting && $setting->price_guarantee_text ? $setting->price_guarantee_text : 'Price Match Guarantee'); ?></span>
                        </p>
                    </li>
                </ul>
            </div>
...
<?php /**PATH E:\sajjel\laragon\www\carpartslb.com\resources\views/components/Front/notice_bar.blade.php ENDPATH**/ ?>