...
<section class="contact__section section--padding">
    <div class="container">
        <div class="contact__section--heading text-center mb-40">
            ...
            <p class="contact__section--heading__desc">Have questions about our auto parts? Get in touch with us today for quick support, expert advice, and reliable service.</p>
        </div>
        <div class="main__contact--area position__relative">
            <div class="contact__form">
                ...
                <form class="contact__form--inner" action="<?php echo e(route('contact.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="row">
                        <div class="col-lg-6 col-md-6">
                            <div class="contact__form--list mb-20">
                                ...
                                <input class="contact__form--input" name="first_name" id="firstName"
                                    placeholder="Your First Name" type="text" value="<?php echo e(old('first_name')); ?>" autocomplete>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6">
                            <div class="contact__form--list mb-20">
                                ...
                                <input class="contact__form--input" name="last_name" id="lastName"
                                    placeholder="Your Last Name" type="text" value="<?php echo e(old('last_name')); ?>" autocomplete>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6">
                            <div class="contact__form--list mb-20">
                                <label class="contact__form--label" for="phoneNumber">Phone Number <span
                                        class="contact__form--label__star">*</span></label>
                                <input class="contact__form--input" name="phone" value="<?php echo e(old('phone')); ?>" id="phoneNumber" placeholder="Phone number"
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="contact__form--list mb-20">
                                ...
                                <input class="contact__form--input" name="email" id="mail" placeholder="Email"
                                    type="text" value="<?php echo e(old('email')); ?>" autocomplete>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="contact__form--list mb-15">
                                <label class="contact__form--label" for="msg">Write Your Message <span
                                        class="contact__form--label__star">*</span></label>
                                <textarea class="contact__form--textarea" name="message" id="msg"
                                    placeholder="Write Your Message" value="<?php echo e(old('message')); ?>"></textarea>
                            </div>
                        </div>
                    </div>
                ...
                <div class="contact__info--items">
                    ...
                    <div class="contact__info--items__inner d-flex">
                        <div class="contact__info--icon">
                           <svg xmlns="http://www.w3.org/2000/svg" width="31" height="31" fill="white" stroke="white" class="bi bi-whatsapp" viewBox="0 0 16 16">
...
<?php echo $__env->make('layouts.front.front-layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u770170027/domains/carpartslb.com/public_html/resources/views/front/pages/contact.blade.php ENDPATH**/ ?>