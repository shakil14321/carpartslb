        ...
        <div class="modal-dialog modal-danger" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form action="<?php echo e(route('categoryImage.deleteSingle')); ?>" method="POST" style="display:inline;">
                        <?php echo csrf_field(); ?>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
            ...
            <!-- Submite images -->
            <form action="<?php echo e(route('category.upload')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
<!-- End upload image Modal -->
    ...
    <h2 style="padding:0 20px 10px 20px">Category Images</h2>

    <!-- MULTI DELETE FORM -->
    <form action="<?php echo e(route('categoryImage.deleteSelected')); ?>" method="POST">
        <?php echo csrf_field(); ?>
        <?php echo method_field('DELETE'); ?>
...
<?php echo $__env->make('layouts.admin.admin-layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\sajjel\laragon\www\carpartslb.com\resources\views/admin/media/category.blade.php ENDPATH**/ ?>