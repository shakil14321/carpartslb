    ...
    <div class="offcanvas__inner">
        <div class="offcanvas__logo">
            <a class="offcanvas__logo_link" href="<?php echo e(route('home')); ?>">
                <img src="<?php echo e(asset('public/assets/front/img/logo/car-part-lb.jpg')); ?>" alt="Grocee Logo" width="158" height="36">
            </a>
        ...
        <nav class="offcanvas__menu">
            <ul class="offcanvas__menu_ul">
                ...
                <?php endif; ?>
                <li class="offcanvas__menu_li">
                    <a class="offcanvas__menu_item" href="<?php echo e(route('home')); ?>">Browse By Part Brands</a>
                    <ul class="offcanvas__sub_menu">
                        ...
                        <?php if($carPartBrands->count() > 0): ?>
                            <?php $__currentLoopData = $carPartBrands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $carPartBrand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="offcanvas__sub_menu_li"><a href="<?php echo e(route('partBrand.view', $carPartBrand->slug)); ?>" class="offcanvas__sub_menu_item"><?php echo e($carPartBrand->title); ?></a></li>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php else: ?>
            ...
            <div class="offcanvas__account--items">
                <a class="offcanvas__account--items__btn d-flex align-items-center" href="<?php echo e(Auth::check() && Auth::user()->role === 'customer' ? route('customerDashboard') : route('login.form')); ?>">
                    ...
                    <span class="offcanvas__account--items__label"><?php echo e(Auth::check() && Auth::user()->role === 'customer' ? ucwords(Auth::user()->name) : 'Login / Register'); ?></span>
                </a>
            </div>
        </nav>
    </div>
</div>
<?php /**PATH /home/u770170027/domains/carpartslb.com/public_html/resources/views/components/Front/offcanvas_menu.blade.php ENDPATH**/ ?>