                        ...
                        <div class="hero__slider--wrapper swiper-wrapper">
                            <div class="swiper-slide ">
                                <div class="hero__slider--items__style2 home2-slider1-bg">
                                    <div class="slider__content style2">
                                        ...
                                        ?>
                                        <span
                                            class="slider__subtitle text__secondary"><?php echo e($setting && $setting->slider1_subtitle ? $setting->slider1_subtitle : 'SHOP THE VERY BEST'); ?></span>
                                        <h2 class="slider__maintitle--style2 h1">
                                            <?php echo e($setting && $setting->slider1_maintitle ? $setting->slider1_maintitle : 'AUTO PARTS & ACCESSORIES'); ?>

                                        </h2>
                                        <p class="slider__desc text__secondary">
                                            <?php echo e($setting && $setting->slider1_desc ? $setting->slider1_desc : 'High Quality - Extreme Performance'); ?>
                            ...
                            <div class="swiper-slide ">
                                <div class="hero__slider--items__style2 home2-slider1-bg">
                                    <div class="slider__content style2">
                                        <span
                                            class="slider__subtitle text__secondary"><?php echo e($setting && $setting->slider2_subtitle ? $setting->slider2_subtitle : 'SHOP THE VERY BEST'); ?></span>
                                        <h2 class="slider__maintitle--style2 h1">
                                            <?php echo e($setting && $setting->slider2_maintitle ? $setting->slider2_maintitle : 'AUTO PARTS & ACCESSORIES'); ?>

                                        </h2>
                                        <p class="slider__desc text__secondary">
                                            <?php echo e($setting && $setting->slider2_desc ? $setting->slider2_desc : 'High Quality - Extreme Performance'); ?>
                            ...
                            <div class="swiper-slide ">
                                <div class="hero__slider--items__style2 home2-slider1-bg">
                                    <div class="slider__content style2">
                                        <span
                                            class="slider__subtitle text__secondary"><?php echo e($setting && $setting->slider3_subtitle ? $setting->slider3_subtitle : 'SHOP THE VERY BEST'); ?></span>
                                        <h2 class="slider__maintitle--style2 h1">
                                            <?php echo e($setting && $setting->slider3_maintitle ? $setting->slider3_maintitle : 'AUTO PARTS & ACCESSORIES'); ?>

                                        </h2>
                                        <p class="slider__desc text__secondary">
                                            <?php echo e($setting && $setting->slider3_desc ? $setting->slider3_desc : 'High Quality - Extreme Performance'); ?>
                    ...
                    <?php $__currentLoopData = $carBrands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $carBrand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-12 col-sm-6 col-md-4 justify-content-center align-items-center">
                            <div class="brand_img_wrap card mb-4">
                                <a href="<?php echo e(route('brand.view', $carBrand->slug)); ?>"><img
                                        src="<?php echo e($carBrand->brand_image ? asset('public/images/brands/' . $carBrand->brand_image) : asset('public/images/brands/demo.png')); ?>"
                                        alt="<?php echo e($carBrand->title); ?>"></a>
                            </div>
                        </div>
