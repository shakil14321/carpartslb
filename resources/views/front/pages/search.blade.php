                                    ...
                                    <div class="price__filter--group">
                                        ...
                                        <div class="price__filter--input d-flex align-items-center">
                                            ...
                                            <input class="price__filter--input__field border-0 custom_price_field"
                                                ...
                                                placeholder="{{ $globalMinPrice }}" value="{{ request('min_price') }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="price__filter--group">
                                        ...
                                        <div class="price__filter--input d-flex align-items-center">
                                            ...
                                            <input class="price__filter--input__field border-0 custom_price_field"
                                                ...
                                                placeholder="{{ $globalMaxPrice }}" value="{{ request('max_price') }}">
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <li class="widget__categories--menu__list">
                                            <a href="{{ route('type.view', $carPartType->slug) }}">
                                                <label class="widget__categories--menu__label d-flex align-items-center">
                                                    ...
                                                    <span
                                                        class="widget__categories--menu__text">{{ $carPartType->title }}</span>
                                                </label>
                                            </a>
                                        </li>
                                    @endforeach
