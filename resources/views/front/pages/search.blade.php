        ...
        <div class="row row-cols-1">
            <div class="col">
                <div class="breadcrumb__content text-center">
                    <h1 class="breadcrumb__content--title">Search Results For: {{ request()->query('query') }}</h1>
                            ...
                            <li class="widget__categories--menu__list">
                                <a href="{{ route('type.view', $carPartType->slug) }}">
                                    <label class="widget__categories--menu__label d-flex align-items-center">
                                        ...
                                        <span class="widget__categories--menu__text">{{ $carPartType->title }}</span>
                                    </label>
                                </a>
                            </li>
                            @endforeach
                        ...
                        <div class="shop__sidebar--product">
                            ...
                            <div class="small__product--card d-flex">
                                <div class="small__product--thumbnail">
                                    ...
                                    <a class="display-block" href="{{ route('product.details', $carPartFav->slug) }}">
                            ...
                            <div id="product_grid" class="tab_pane active show">
                                <div class="product__section--inner">
                                    <div class="row mb--n30" id="car-parts-container">
                                        @include('front.partials.car_parts_list', ['carParts' => $carParts])
                                    </div>
                                </div>
                            </div>
