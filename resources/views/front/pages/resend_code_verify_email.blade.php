                    ...
                    <div class="col">
                        <div class="account__login">
                            <div class="account__login--header mb-25">
                                <h2 class="account__login--header__title mb-10">Resend Code</h2>
                                   @if ($errors->any())
                            ...
                            <div class="account__login--inner">
                                ...
                                <button class="account__login--btn primary__btn" type="submit">Resend Code</button>
                            </div>
                            {{-- reCAPTCHA widget --}}
                            {{-- {!! app('captcha')->display() !!}
                            ...
                            <p class="account__login--signup__text">Already have a code? <a
                                    href="{{ route('verify.form') }}">Enter it</a></p>
                        </div>
                    </div>
