            ...
            @if($carBrands->count() > 0)
                ...
                <div class="col-12 col-sm-6 col-md-4 justify-content-center align-items-center">
                    <div class="brand_img_wrap card mb-4">
                        <a href="{{ route('brand.view', $carBrand->slug) }}"><img src="{{ $carBrand->brand_image ? asset('public/images/brands/' . $carBrand->brand_image) : asset('public/images/brands/demo.png') }}" alt="{{ $carBrand->title }}"></a>
                    </div>
                </div>
                @endforeach
