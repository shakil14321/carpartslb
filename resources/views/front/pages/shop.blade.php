                        ...
                        <div class="shop__sidebar--product">
                            ...
                            <div class="small__product--card">
                                <div class="small__product--thumbnail">
                                    <a class="display-block" href="{{ route('product.view', $carPartFav->slug) }}" style="height:150px !important;">
                                        ...
                                        @else
                                        <img class="product__card--thumbnail__img product__primary--img"
                                            src="{{ asset('public/images/brands/demo.png') }}" alt="no-image" style="width:100%; height:100%; object-fit:cover;">
                                        @endif
                                    </a>
                                </div>
