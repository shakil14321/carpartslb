                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="contact__form--list mb-20">
                                ...
                                <input class="contact__form--input" name="first_name" id="firstName"
                                    placeholder="Your First Name" type="text" value="{{ old('first_name') }}" autocomplete>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6">
                            <div class="contact__form--list mb-20">
                                ...
                                <input class="contact__form--input" name="last_name" id="lastName"
                                    placeholder="Your Last Name" type="text" value="{{ old('last_name') }}" autocomplete>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6">
                            <div class="contact__form--list mb-20">
                                <label class="contact__form--label" for="phoneNumber">Phone Number <span
                                        class="contact__form--label__star">*</span></label>
                                <input class="contact__form--input" name="phone" value="{{ old('phone') }}" id="phoneNumber" placeholder="Phone number"
                        ...
                        <div class="col-12">
                            <div class="contact__form--list mb-15">
                                ...
                                <textarea class="contact__form--textarea" name="message" id="msg"
                                    placeholder="Write Your Message" value="{{ old('message') }}"></textarea>
                            </div>
                        </div>
                    </div>
