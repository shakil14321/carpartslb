        ...
        <div class="modal-dialog modal-danger" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form action="{{ route('brandImage.deleteSingle') }}" method="POST" style="display:inline;">
                        @csrf
                        @method('DELETE')
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
            ...
            <!-- Submite images -->
            <form action="{{ route('brand.upload') }}" method="POST" enctype="multipart/form-data">
                @csrf
...
<!-- End upload image Modal -->
    ...
    <!-- MULTI DELETE FORM -->
    <form action="{{ route('brandImage.deleteSelected') }}" method="POST">
        @csrf
        @method('DELETE')
