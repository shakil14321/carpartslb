        ...
        <div class="modal-dialog modal-danger" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form action="{{ route('modelImage.deleteSingle') }}" method="POST" style="display:inline;">
                        @csrf
                        @method('DELETE')
...
<!-- search form -->
    <form action="{{ route('modelImage.search') }}" method="get">
...
<!-- /.search form -->
    ...
    <!-- MULTI DELETE FORM -->
    <form action="{{ route('modelImage.deleteSelected') }}" method="POST">
        @csrf
        @method('DELETE')
