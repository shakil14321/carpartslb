    ...
    <section class="content container-fluid">
        ...
        <div class="guide-box" style="margin:0 0 10px 0;">
            <code>
                ...
                content="<mark class="bg-success">AbCdEfGhIjKlMnOpQrStUvWxYz1234567890</mark>" /&gt;
            </code>
        </div>
        ...
        <form action="{{ route('site.setting.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" id="googleVerification" name="google_verification"
                    value="{{ $setting->google_verification ?? '' }}" class="form-control"
