                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="#" class="all-email">{{ $user->phone ?? '' }}</a></td>
                                <td>{{ ucwords($user->role ?? '') }}</td>
                                <td><p class="verificaton_btn {{ !is_null($user->email_verified_at) ? 'text-success' : 'text-danger'}}">{{ !is_null($user->email_verified_at) ? "Done" : "None"}}</p></td>
                                <td>
                                    <div class="action-container">
                                        <a href="{{ route('user.edit', $user->id) }}" class="edit-icon"><i
                                                class="fa fa-edit"></i></a>
                                        <span class="delete-icon fa fa-trash-o" data-toggle="modal" data-target="#deleteModal{{ $user->id }}" data-id="{{ $user->id }}"><i></i></span>
