    ...
    <div class="col-md-12">
        <div class="box box-primary">
            <div class="box-header">
                ...
                <h3 class="box-title">Import Car Types (Categories)</h3>
            ...
            <div class="box-body pad table-responsive">
                ...
                <div >
                    <a href="{{ route('part-types.export') }}" class="btn btn-primary">Excel Sheet Template</a>
                </div>
            </div>
            <div class="box-body pad table-responsive">
                <p>Click here to import the products by excel sheet</p>
                <div>
                    <form action="{{ route('part-type.import') }}" method="POST" enctype="multipart/form-data"
