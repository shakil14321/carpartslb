            ...
            <div class="col-xs-12">
                ...
                <div class="box">
                    <div class="main-flex">
                        ...
                        <a href="{{ route('brand.create') }}" class="btn btn-primary btn-sm">Add New Brand</a>
                    </div><!-- /.box-header -->
                    <div class="box-body">
                        <form action="{{ route('brand.deleteSelected') }}" method="POST">
                            @csrf
                                    ...
                                    @if ($brands->count() > 0)
                                        @foreach ($brands as $brand)
                                            <tr>
                                                ...
                                                <td><a href="#" class="all-title">{{ $brand->title }}</a></td>
                                                <td>
                                                    <div class="action-container">
                                                        <a href="{{ route('brand.edit', $brand->id) }}"
                                                            class="edit-icon"><i class="fa fa-edit"></i></a>
                                                        <span class="delete-icon fa fa-trash-o" data-toggle="modal" data-target="#deleteModal{{ $brand->id }}" data-id="{{ $brand->id }}"><i></i></span>
