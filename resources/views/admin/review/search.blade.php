                                    ...
                                    @if ($reviews->count() > 0)
                                        @foreach ($reviews as $review)
                                            <tr>
                                                ...
                                                <td><a href="#" class="all-title">{{ $review->rating ?? '' }}</a></td> 
                                                <td><a href="{{ $review->product_url ?? '' }}" class="all-title">{{ $review->product_title ?? '' }}</a></td> 
                                                <td>
                                                    <div class="action-container">
                                                        <span type="submit" class="delete-icon"><i
