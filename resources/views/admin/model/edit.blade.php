    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                @endif
                <div class="main-flex">
                    <h3 class="box-title">Update Car Model</h3>
                    <a href="{{ route('model.index') }}" class="btn btn-primary btn-sm">All Models</a>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form role="form" action="{{ route('model.update',  $carModel->id) }}" method="POST"
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control brand-name" id="input-title"
                                placeholder="Enter car model name" name="title"
                                value="{{ old('title', $carModel->title) }}">
                        </div>
                        <div class="input-group">
                            <input type="text" class="form-control" id="input-slug" placeholder="Slug will generate"
                                name="slug" value="{{ old('slug', $carModel->slug) }}" readonly>
                                ...
                                <div class='col-md-12'>
                                    <div class='box'>
                                        ...
                                        <div class='box-body pad'>
                                            ...
                                            <textarea class="textarea summernote" name="description">{{ old('description', $carModel->description) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="year">
                                @for($year = 1980; $year <= 2025; $year++) <option value="{{ $year }}" {{ old('year',
                                    $carModel->year) == $year ? 'selected' : '' }}>
                                    {{ $year }}
                                    </option>
                                @endfor
                        ...
                        <div class="form-group">
                            ...
                            <br>
                            <img src="{{ old('model_image') ? asset('public/images/models/' . old('model_image', $carModel->model_image)) : asset('public/images/brands/demo.png') ; }}"
