                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="part_type_id" id="car-brands">
                                    <option disabled {{ old('part_type_id') ? '' : 'selected' }}>Choose one Category</option>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control seo_title" id="seoTitle"
                                         placeholder="Write a short and catchy meta title (about 60 characters)..." name="meta_title" value="{{ old('meta_title') }}">
                            </div>
                            
                             <!-- seo description input -->
                            <div class="form-group">
                                <label for="seoDescription">Seo Description</label>
                                <textarea class="form-control seo_description" id="seoDescription" name="meta_description"  placeholder="Write a short and catchy meta description (about 160 characters)...">{{ old('meta_description') }}</textarea>
                            </div>
                        </div><!-- /.box-body -->
